...
/* 295 */   public static final Class<Character> TYPE = null;
...
/* 149 */   public char charValue() { throw new RuntimeException("Stub!"); } 
/* 150 */   public int compareTo(Character c) { throw new RuntimeException("Stub!"); } 
/* 151 */   public static Character valueOf(char c) { throw new RuntimeException("Stub!"); } 
/* 152 */   public static boolean isValidCodePoint(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 153 */   public static boolean isSupplementaryCodePoint(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 154 */   public static boolean isHighSurrogate(char ch) { throw new RuntimeException("Stub!"); } 
/* 155 */   public static boolean isLowSurrogate(char ch) { throw new RuntimeException("Stub!"); } 
/* 156 */   public static boolean isSurrogatePair(char high, char low) { throw new RuntimeException("Stub!"); } 
/* 157 */   public static int charCount(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 158 */   public static int toCodePoint(char high, char low) { throw new RuntimeException("Stub!"); } 
/* 159 */   public static int codePointAt(CharSequence seq, int index) { throw new RuntimeException("Stub!"); } 
/* 160 */   public static int codePointAt(char[] seq, int index) { throw new RuntimeException("Stub!"); } 
/* 161 */   public static int codePointAt(char[] seq, int index, int limit) { throw new RuntimeException("Stub!"); } 
/* 162 */   public static int codePointBefore(CharSequence seq, int index) { throw new RuntimeException("Stub!"); } 
/* 163 */   public static int codePointBefore(char[] seq, int index) { throw new RuntimeException("Stub!"); } 
/* 164 */   public static int codePointBefore(char[] seq, int index, int start) { throw new RuntimeException("Stub!"); } 
/* 165 */   public static int toChars(int codePoint, char[] dst, int dstIndex) { throw new RuntimeException("Stub!"); } 
/* 166 */   public static char[] toChars(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 167 */   public static int codePointCount(CharSequence seq, int beginIndex, int endIndex) { throw new RuntimeException("Stub!"); } 
/* 168 */   public static int codePointCount(char[] seq, int offset, int count) { throw new RuntimeException("Stub!"); } 
/* 169 */   public static int offsetByCodePoints(CharSequence seq, int index, int codePointOffset) { throw new RuntimeException("Stub!"); } 
/* 170 */   public static int offsetByCodePoints(char[] seq, int start, int count, int index, int codePointOffset) { throw new RuntimeException("Stub!"); } 
/* 171 */   public static int digit(char c, int radix) { throw new RuntimeException("Stub!"); } 
/* 172 */   public static int digit(int codePoint, int radix) { throw new RuntimeException("Stub!"); } 
/* 173 */   public boolean equals(Object object) { throw new RuntimeException("Stub!"); } 
/* 174 */   public static char forDigit(int digit, int radix) { throw new RuntimeException("Stub!"); } 
/* 175 */   public static int getNumericValue(char c) { throw new RuntimeException("Stub!"); } 
/* 176 */   public static int getNumericValue(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 177 */   public static int getType(char c) { throw new RuntimeException("Stub!"); } 
/* 178 */   public static int getType(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 179 */   public static byte getDirectionality(char c) { throw new RuntimeException("Stub!"); } 
/* 180 */   public static byte getDirectionality(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 181 */   public static boolean isMirrored(char c) { throw new RuntimeException("Stub!"); } 
/* 182 */   public static boolean isMirrored(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 183 */   public int hashCode() { throw new RuntimeException("Stub!"); } 
/* 184 */   public static boolean isDefined(char c) { throw new RuntimeException("Stub!"); } 
/* 185 */   public static boolean isDefined(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 186 */   public static boolean isDigit(char c) { throw new RuntimeException("Stub!"); } 
/* 187 */   public static boolean isDigit(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 188 */   public static boolean isIdentifierIgnorable(char c) { throw new RuntimeException("Stub!"); } 
/* 189 */   public static boolean isIdentifierIgnorable(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 190 */   public static boolean isISOControl(char c) { throw new RuntimeException("Stub!"); } 
/* 191 */   public static boolean isISOControl(int c) { throw new RuntimeException("Stub!"); } 
/* 192 */   public static boolean isJavaIdentifierPart(char c) { throw new RuntimeException("Stub!"); } 
/* 193 */   public static boolean isJavaIdentifierPart(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 194 */   public static boolean isJavaIdentifierStart(char c) { throw new RuntimeException("Stub!"); } 
/* 195 */   public static boolean isJavaIdentifierStart(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 197 */   @Deprecated
...
/* 200 */   public static boolean isLetter(char c) { throw new RuntimeException("Stub!"); } 
/* 201 */   public static boolean isLetter(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 202 */   public static boolean isLetterOrDigit(char c) { throw new RuntimeException("Stub!"); } 
/* 203 */   public static boolean isLetterOrDigit(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 204 */   public static boolean isLowerCase(char c) { throw new RuntimeException("Stub!"); } 
/* 205 */   public static boolean isLowerCase(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 207 */   @Deprecated
/*     */   public static boolean isSpace(char c) { throw new RuntimeException("Stub!"); } 
/* 208 */   public static boolean isSpaceChar(char c) { throw new RuntimeException("Stub!"); } 
/* 209 */   public static boolean isSpaceChar(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 210 */   public static boolean isTitleCase(char c) { throw new RuntimeException("Stub!"); } 
/* 211 */   public static boolean isTitleCase(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 212 */   public static boolean isUnicodeIdentifierPart(char c) { throw new RuntimeException("Stub!"); } 
/* 213 */   public static boolean isUnicodeIdentifierPart(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 214 */   public static boolean isUnicodeIdentifierStart(char c) { throw new RuntimeException("Stub!"); } 
/* 215 */   public static boolean isUnicodeIdentifierStart(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 216 */   public static boolean isUpperCase(char c) { throw new RuntimeException("Stub!"); } 
/* 217 */   public static boolean isUpperCase(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 218 */   public static boolean isWhitespace(char c) { throw new RuntimeException("Stub!"); } 
/* 219 */   public static boolean isWhitespace(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 220 */   public static char reverseBytes(char c) { throw new RuntimeException("Stub!"); } 
/* 221 */   public static char toLowerCase(char c) { throw new RuntimeException("Stub!"); } 
/* 222 */   public static int toLowerCase(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 223 */   public String toString() { throw new RuntimeException("Stub!"); } 
/* 224 */   public static String toString(char value) { throw new RuntimeException("Stub!"); } 
/* 225 */   public static char toTitleCase(char c) { throw new RuntimeException("Stub!"); } 
/* 226 */   public static int toTitleCase(int codePoint) { throw new RuntimeException("Stub!"); } 
/* 227 */   public static char toUpperCase(char c) { throw new RuntimeException("Stub!"); } 
/* 228 */   public static int toUpperCase(int codePoint) { throw new RuntimeException("Stub!"); }
/*     */ 
/*     */ 
