...
/*    */     throws IOException
/*    */   {
/*  5 */     super((File)null, 0); throw new RuntimeException("Stub!"); } 
/*  6 */   public JarFile(File file, boolean verify) throws IOException { super((File)null, 0); throw new RuntimeException("Stub!"); } 
/*  7 */   public JarFile(File file, boolean verify, int mode) throws IOException { super((File)null, 0); throw new RuntimeException("Stub!"); } 
/*  8 */   public JarFile(String filename) throws IOException { super((File)null, 0); throw new RuntimeException("Stub!"); } 
/*  9 */   public JarFile(String filename, boolean verify) throws IOException { super((File)null, 0); throw new RuntimeException("Stub!"); } 
