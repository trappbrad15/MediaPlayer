...
/* 22 */   protected final int getState() { throw new RuntimeException("Stub!"); } 
/* 23 */   protected final void setState(int newState) { throw new RuntimeException("Stub!"); } 
/* 24 */   protected final boolean compareAndSetState(int expect, int update) { throw new RuntimeException("Stub!"); } 
/* 25 */   protected boolean tryAcquire(int arg) { throw new RuntimeException("Stub!"); } 
/* 26 */   protected boolean tryRelease(int arg) { throw new RuntimeException("Stub!"); } 
/* 27 */   protected int tryAcquireShared(int arg) { throw new RuntimeException("Stub!"); } 
/* 28 */   protected boolean tryReleaseShared(int arg) { throw new RuntimeException("Stub!"); } 
/* 29 */   protected boolean isHeldExclusively() { throw new RuntimeException("Stub!"); } 
/* 30 */   public final void acquire(int arg) { throw new RuntimeException("Stub!"); } 
/* 31 */   public final void acquireInterruptibly(int arg) throws InterruptedException { throw new RuntimeException("Stub!"); } 
/* 32 */   public final boolean tryAcquireNanos(int arg, long nanosTimeout) throws InterruptedException { throw new RuntimeException("Stub!"); } 
/* 33 */   public final boolean release(int arg) { throw new RuntimeException("Stub!"); } 
/* 34 */   public final void acquireShared(int arg) { throw new RuntimeException("Stub!"); } 
/* 35 */   public final void acquireSharedInterruptibly(int arg) throws InterruptedException { throw new RuntimeException("Stub!"); } 
/* 36 */   public final boolean tryAcquireSharedNanos(int arg, long nanosTimeout) throws InterruptedException { throw new RuntimeException("Stub!"); } 
/* 37 */   public final boolean releaseShared(int arg) { throw new RuntimeException("Stub!"); } 
