...
/*    */   }
/* 51 */   public double nextDouble() { throw new RuntimeException("Stub!"); } 
/*    */   public float nextFloat() {
/* 53 */     throw new RuntimeException("Stub!"); } 
/* 54 */   public int nextInt() { throw new RuntimeException("Stub!"); } 
/*    */   public int nextInt(int radix) {
/* 56 */     throw new RuntimeException("Stub!"); } 
/* 57 */   public String nextLine() { throw new RuntimeException("Stub!"); } 
/* 58 */   public long nextLong() { throw new RuntimeException("Stub!"); } 
/*    */   public long nextLong(int radix) {
/* 60 */     throw new RuntimeException("Stub!"); } 
/* 61 */   public short nextShort() { throw new RuntimeException("Stub!"); } 
/*    */   public short nextShort(int radix) {
/* 63 */     throw new RuntimeException("Stub!"); } 
/* 64 */   public int radix() { throw new RuntimeException("Stub!"); } 
...
/* 68 */   public Scanner useDelimiter(Pattern pattern) { throw new RuntimeException("Stub!"); } 
/* 69 */   public Scanner useDelimiter(String pattern) { throw new RuntimeException("Stub!"); } 
/* 70 */   public Scanner useLocale(Locale l) { throw new RuntimeException("Stub!"); } 
/* 71 */   public Scanner useRadix(int radix) { throw new RuntimeException("Stub!"); } 
/* 72 */   public void remove() { throw new RuntimeException("Stub!"); } 
/* 73 */   public Scanner reset() { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ }
