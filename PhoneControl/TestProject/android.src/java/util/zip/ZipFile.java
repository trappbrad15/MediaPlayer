...
/*  5 */   public ZipFile(String name) throws IOException { throw new RuntimeException("Stub!"); } 
/*  6 */   public ZipFile(File file, int mode) throws IOException { throw new RuntimeException("Stub!"); } 
