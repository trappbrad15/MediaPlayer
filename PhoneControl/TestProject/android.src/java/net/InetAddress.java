...
/* 16 */   public boolean isAnyLocalAddress() { throw new RuntimeException("Stub!"); } 
/* 17 */   public boolean isLinkLocalAddress() { throw new RuntimeException("Stub!"); } 
/* 18 */   public boolean isLoopbackAddress() { throw new RuntimeException("Stub!"); } 
/* 19 */   public boolean isMCGlobal() { throw new RuntimeException("Stub!"); } 
/* 20 */   public boolean isMCLinkLocal() { throw new RuntimeException("Stub!"); } 
/* 21 */   public boolean isMCNodeLocal() { throw new RuntimeException("Stub!"); } 
/* 22 */   public boolean isMCOrgLocal() { throw new RuntimeException("Stub!"); } 
/* 23 */   public boolean isMCSiteLocal() { throw new RuntimeException("Stub!"); } 
/* 24 */   public boolean isMulticastAddress() { throw new RuntimeException("Stub!"); } 
/* 25 */   public boolean isSiteLocalAddress() { throw new RuntimeException("Stub!"); } 
