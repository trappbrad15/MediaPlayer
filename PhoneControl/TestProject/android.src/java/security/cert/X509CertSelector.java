...
/* 51 */   public void addPathToName(int type, String name) throws IOException { throw new RuntimeException("Stub!"); } 
/* 52 */   public void setPathToNames(Collection<List<?>> names) throws IOException { throw new RuntimeException("Stub!"); } 
