...
/* 22 */   public ObjectOutputStream(OutputStream output) throws IOException { throw new RuntimeException("Stub!"); } 
/* 23 */   protected void annotateClass(Class<?> aClass) throws IOException { throw new RuntimeException("Stub!"); } 
/* 24 */   protected void annotateProxyClass(Class<?> aClass) throws IOException { throw new RuntimeException("Stub!"); } 
/* 25 */   public void close() throws IOException { throw new RuntimeException("Stub!"); } 
/* 26 */   public void defaultWriteObject() throws IOException { throw new RuntimeException("Stub!"); } 
/* 27 */   protected void drain() throws IOException { throw new RuntimeException("Stub!"); } 
/* 28 */   protected boolean enableReplaceObject(boolean enable) { throw new RuntimeException("Stub!"); } 
/* 29 */   public void flush() throws IOException { throw new RuntimeException("Stub!"); } 
/* 30 */   public PutField putFields() throws IOException { throw new RuntimeException("Stub!"); } 
/* 31 */   protected Object replaceObject(Object object) throws IOException { throw new RuntimeException("Stub!"); } 
/* 32 */   public void reset() throws IOException { throw new RuntimeException("Stub!"); } 
/* 33 */   public void useProtocolVersion(int version) throws IOException { throw new RuntimeException("Stub!"); } 
