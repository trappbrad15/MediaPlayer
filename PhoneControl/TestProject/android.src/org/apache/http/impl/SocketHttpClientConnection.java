...
/*  9 */   protected SessionInputBuffer createSessionInputBuffer(Socket socket, int buffersize, HttpParams params) throws IOException { throw new RuntimeException("Stub!"); } 
/* 10 */   protected SessionOutputBuffer createSessionOutputBuffer(Socket socket, int buffersize, HttpParams params) throws IOException { throw new RuntimeException("Stub!"); } 
/* 11 */   protected void bind(Socket socket, HttpParams params) throws IOException { throw new RuntimeException("Stub!"); } 
/* 12 */   public boolean isOpen() { throw new RuntimeException("Stub!"); } 
/* 13 */   protected Socket getSocket() { throw new RuntimeException("Stub!"); } 
