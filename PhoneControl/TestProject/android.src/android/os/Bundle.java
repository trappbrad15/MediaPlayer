...
/*    */ {
/* 97 */   public static final Bundle EMPTY = null; public static final Parcelable.Creator<Bundle> CREATOR = null;
/*    */ 
/*    */   public Bundle()
/*    */   {
...
/* 50 */   public void putBinder(String key, IBinder value) { throw new RuntimeException("Stub!"); } 
/* 51 */   public boolean getBoolean(String key) { throw new RuntimeException("Stub!"); } 
/* 52 */   public boolean getBoolean(String key, boolean defaultValue) { throw new RuntimeException("Stub!"); } 
/* 53 */   public byte getByte(String key) { throw new RuntimeException("Stub!"); } 
/* 54 */   public Byte getByte(String key, byte defaultValue) { throw new RuntimeException("Stub!"); } 
/* 55 */   public char getChar(String key) { throw new RuntimeException("Stub!"); } 
/* 56 */   public char getChar(String key, char defaultValue) { throw new RuntimeException("Stub!"); } 
/* 57 */   public short getShort(String key) { throw new RuntimeException("Stub!"); } 
/* 58 */   public short getShort(String key, short defaultValue) { throw new RuntimeException("Stub!"); } 
/* 59 */   public int getInt(String key) { throw new RuntimeException("Stub!"); } 
/* 60 */   public int getInt(String key, int defaultValue) { throw new RuntimeException("Stub!"); } 
/* 61 */   public long getLong(String key) { throw new RuntimeException("Stub!"); } 
/* 62 */   public long getLong(String key, long defaultValue) { throw new RuntimeException("Stub!"); } 
...
/* 65 */   public double getDouble(String key) { throw new RuntimeException("Stub!"); } 
/* 66 */   public double getDouble(String key, double defaultValue) { throw new RuntimeException("Stub!"); } 
/* 67 */   public String getString(String key) { throw new RuntimeException("Stub!"); } 
/* 68 */   public String getString(String key, String defaultValue) { throw new RuntimeException("Stub!"); } 
/* 69 */   public CharSequence getCharSequence(String key) { throw new RuntimeException("Stub!"); } 
/* 70 */   public CharSequence getCharSequence(String key, CharSequence defaultValue) { throw new RuntimeException("Stub!"); } 
/* 71 */   public Bundle getBundle(String key) { throw new RuntimeException("Stub!"); } 
/* 72 */   public <T extends Parcelable> T getParcelable(String key) { throw new RuntimeException("Stub!"); } 
/* 73 */   public Parcelable[] getParcelableArray(String key) { throw new RuntimeException("Stub!"); } 
/* 74 */   public <T extends Parcelable> ArrayList<T> getParcelableArrayList(String key) { throw new RuntimeException("Stub!"); } 
/* 75 */   public <T extends Parcelable> SparseArray<T> getSparseParcelableArray(String key) { throw new RuntimeException("Stub!"); } 
/* 76 */   public Serializable getSerializable(String key) { throw new RuntimeException("Stub!"); } 
/* 77 */   public ArrayList<Integer> getIntegerArrayList(String key) { throw new RuntimeException("Stub!"); } 
/* 78 */   public ArrayList<String> getStringArrayList(String key) { throw new RuntimeException("Stub!"); } 
/* 79 */   public ArrayList<CharSequence> getCharSequenceArrayList(String key) { throw new RuntimeException("Stub!"); } 
/* 80 */   public boolean[] getBooleanArray(String key) { throw new RuntimeException("Stub!"); } 
/* 81 */   public byte[] getByteArray(String key) { throw new RuntimeException("Stub!"); } 
/* 82 */   public short[] getShortArray(String key) { throw new RuntimeException("Stub!"); } 
/* 83 */   public char[] getCharArray(String key) { throw new RuntimeException("Stub!"); } 
/* 84 */   public int[] getIntArray(String key) { throw new RuntimeException("Stub!"); } 
/* 85 */   public long[] getLongArray(String key) { throw new RuntimeException("Stub!"); } 
/* 86 */   public float[] getFloatArray(String key) { throw new RuntimeException("Stub!"); } 
/* 87 */   public double[] getDoubleArray(String key) { throw new RuntimeException("Stub!"); } 
/* 88 */   public String[] getStringArray(String key) { throw new RuntimeException("Stub!"); } 
/* 89 */   public CharSequence[] getCharSequenceArray(String key) { throw new RuntimeException("Stub!"); } 
/* 90 */   public IBinder getBinder(String key) { throw new RuntimeException("Stub!"); } 
/* 91 */   public int describeContents() { throw new RuntimeException("Stub!"); } 
/* 92 */   public void writeToParcel(Parcel parcel, int flags) { throw new RuntimeException("Stub!"); } 
/* 93 */   public void readFromParcel(Parcel parcel) { throw new RuntimeException("Stub!"); } 
/* 94 */   public synchronized String toString() { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ }
