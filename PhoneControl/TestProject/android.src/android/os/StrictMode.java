...
/* 57 */   public static void setThreadPolicy(ThreadPolicy policy) { throw new RuntimeException("Stub!"); } 
/* 58 */   public static ThreadPolicy getThreadPolicy() { throw new RuntimeException("Stub!"); } 
/* 59 */   public static ThreadPolicy allowThreadDiskWrites() { throw new RuntimeException("Stub!"); } 
/* 60 */   public static ThreadPolicy allowThreadDiskReads() { throw new RuntimeException("Stub!"); } 
/* 61 */   public static void setVmPolicy(VmPolicy policy) { throw new RuntimeException("Stub!"); } 
/* 62 */   public static VmPolicy getVmPolicy() { throw new RuntimeException("Stub!"); } 
/* 63 */   public static void enableDefaults() { throw new RuntimeException("Stub!"); } 
/* 64 */   public static void noteSlowCall(String name) { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ 
/*    */   public static final class VmPolicy
/*    */   {
/* 54 */     public static final VmPolicy LAX = null;
/*    */ 
/*    */     VmPolicy()
/*    */     {
...
/* 44 */       public Builder detectLeakedRegistrationObjects() { throw new RuntimeException("Stub!"); } 
/* 45 */       public Builder detectFileUriExposure() { throw new RuntimeException("Stub!"); } 
/* 46 */       public Builder penaltyDeath() { throw new RuntimeException("Stub!"); } 
/* 47 */       public Builder penaltyLog() { throw new RuntimeException("Stub!"); } 
/* 48 */       public Builder penaltyDropBox() { throw new RuntimeException("Stub!"); } 
/* 49 */       public StrictMode.VmPolicy build() { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */     }
/*    */   }
/*    */ 
