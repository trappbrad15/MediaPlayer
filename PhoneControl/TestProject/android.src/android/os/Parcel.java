...
/*   7 */   public final int dataSize() { throw new RuntimeException("Stub!"); } 
/*   8 */   public final int dataAvail() { throw new RuntimeException("Stub!"); } 
/*   9 */   public final int dataPosition() { throw new RuntimeException("Stub!"); } 
/*  10 */   public final int dataCapacity() { throw new RuntimeException("Stub!"); } 
/*  11 */   public final void setDataSize(int size) { throw new RuntimeException("Stub!"); } 
/*  12 */   public final void setDataPosition(int pos) { throw new RuntimeException("Stub!"); } 
/*  13 */   public final void setDataCapacity(int size) { throw new RuntimeException("Stub!"); } 
/*  14 */   public final byte[] marshall() { throw new RuntimeException("Stub!"); } 
/*  15 */   public final void unmarshall(byte[] data, int offest, int length) { throw new RuntimeException("Stub!"); } 
/*  16 */   public final void appendFrom(Parcel parcel, int offset, int length) { throw new RuntimeException("Stub!"); } 
/*  17 */   public final boolean hasFileDescriptors() { throw new RuntimeException("Stub!"); } 
/*  18 */   public final void writeInterfaceToken(String interfaceName) { throw new RuntimeException("Stub!"); } 
/*  19 */   public final void enforceInterface(String interfaceName) { throw new RuntimeException("Stub!"); } 
...
/*  22 */   public final void writeInt(int val) { throw new RuntimeException("Stub!"); } 
/*  23 */   public final void writeLong(long val) { throw new RuntimeException("Stub!"); } 
/*  24 */   public final void writeFloat(float val) { throw new RuntimeException("Stub!"); } 
/*  25 */   public final void writeDouble(double val) { throw new RuntimeException("Stub!"); } 
/*  26 */   public final void writeString(String val) { throw new RuntimeException("Stub!"); } 
/*  27 */   public final void writeStrongBinder(IBinder val) { throw new RuntimeException("Stub!"); } 
/*  28 */   public final void writeStrongInterface(IInterface val) { throw new RuntimeException("Stub!"); } 
/*  29 */   public final void writeFileDescriptor(FileDescriptor val) { throw new RuntimeException("Stub!"); } 
...
/*  72 */   public final int readInt() { throw new RuntimeException("Stub!"); } 
/*  73 */   public final long readLong() { throw new RuntimeException("Stub!"); } 
/*  74 */   public final float readFloat() { throw new RuntimeException("Stub!"); } 
/*  75 */   public final double readDouble() { throw new RuntimeException("Stub!"); } 
/*  76 */   public final String readString() { throw new RuntimeException("Stub!"); } 
/*  77 */   public final IBinder readStrongBinder() { throw new RuntimeException("Stub!"); } 
...
/*  85 */   public final byte[] createByteArray() { throw new RuntimeException("Stub!"); } 
