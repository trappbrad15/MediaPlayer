...
/* 15 */   public ComponentName getGlobalSearchActivity() { throw new RuntimeException("Stub!"); } 
/* 16 */   public void triggerSearch(String query, ComponentName launchActivity, Bundle appSearchData) { throw new RuntimeException("Stub!"); } 
/* 17 */   public void stopSearch() { throw new RuntimeException("Stub!"); } 
/* 18 */   public void setOnDismissListener(OnDismissListener listener) { throw new RuntimeException("Stub!"); } 
/* 19 */   public void setOnCancelListener(OnCancelListener listener) { throw new RuntimeException("Stub!"); } 
/* 21 */   @Deprecated
/*    */   public void onCancel(DialogInterface dialog) { throw new RuntimeException("Stub!"); } 
/* 23 */   @Deprecated
/*    */   public void onDismiss(DialogInterface dialog) { throw new RuntimeException("Stub!"); } 
/* 24 */   public SearchableInfo getSearchableInfo(ComponentName componentName) { throw new RuntimeException("Stub!"); } 
/* 25 */   public List<SearchableInfo> getSearchablesInGlobalSearch() { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ 
