...
/*     */ 
/*  20 */   public static void glColorPointer(int size, int type, int stride, Buffer pointer) { throw new RuntimeException("Stub!"); } 
...
/*     */ 
/*  91 */   public static void glNormalPointer(int type, int stride, Buffer pointer) { throw new RuntimeException("Stub!"); } 
...
/*     */ 
/* 113 */   public static void glTexCoordPointer(int size, int type, int stride, Buffer pointer) { throw new RuntimeException("Stub!"); } 
...
/*     */ 
/* 126 */   public static void glVertexPointer(int size, int type, int stride, Buffer pointer) { throw new RuntimeException("Stub!"); }
/*     */ 
/*     */ 
 ...
 * Qualified Name:     android.opengl.GLES10
