...
/*     */ 
/* 100 */   public static void glMatrixIndexPointerOES(int size, int type, int stride, Buffer pointer) { throw new RuntimeException("Stub!"); } 
/* 101 */   public static void glWeightPointerOES(int size, int type, int stride, Buffer pointer) { throw new RuntimeException("Stub!"); }
/*     */ 
/*     */ 
 ...
 * Qualified Name:     android.opengl.GLES11Ext
