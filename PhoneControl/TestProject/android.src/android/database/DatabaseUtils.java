...
/*  8 */     public int getColumnIndex(String key) { throw new RuntimeException("Stub!"); } 
/*  9 */     public void bind(int index, double value) { throw new RuntimeException("Stub!"); } 
/* 10 */     public void bind(int index, float value) { throw new RuntimeException("Stub!"); } 
/* 11 */     public void bind(int index, long value) { throw new RuntimeException("Stub!"); } 
/* 12 */     public void bind(int index, int value) { throw new RuntimeException("Stub!"); } 
/* 13 */     public void bind(int index, boolean value) { throw new RuntimeException("Stub!"); } 
/* 14 */     public void bindNull(int index) { throw new RuntimeException("Stub!"); } 
/* 15 */     public void bind(int index, byte[] value) { throw new RuntimeException("Stub!"); } 
/* 16 */     public void bind(int index, String value) { throw new RuntimeException("Stub!"); } 
/* 17 */     public long insert(ContentValues values) { throw new RuntimeException("Stub!"); } 
/* 18 */     public long execute() { throw new RuntimeException("Stub!"); } 
/* 19 */     public void prepareForInsert() { throw new RuntimeException("Stub!"); } 
/* 20 */     public void prepareForReplace() { throw new RuntimeException("Stub!"); } 
/* 21 */     public long replace(ContentValues values) { throw new RuntimeException("Stub!"); } 
