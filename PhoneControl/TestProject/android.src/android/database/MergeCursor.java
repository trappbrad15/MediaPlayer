...
/* 14 */   public int getType(int column) { throw new RuntimeException("Stub!"); } 
/* 15 */   public boolean isNull(int column) { throw new RuntimeException("Stub!"); } 
/* 16 */   public byte[] getBlob(int column) { throw new RuntimeException("Stub!"); } 
/* 17 */   public String[] getColumnNames() { throw new RuntimeException("Stub!"); } 
/* 18 */   public void deactivate() { throw new RuntimeException("Stub!"); } 
/* 19 */   public void close() { throw new RuntimeException("Stub!"); } 
/* 20 */   public void registerContentObserver(ContentObserver observer) { throw new RuntimeException("Stub!"); } 
/* 21 */   public void unregisterContentObserver(ContentObserver observer) { throw new RuntimeException("Stub!"); } 
...
/* 24 */   public boolean requery() { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ }
