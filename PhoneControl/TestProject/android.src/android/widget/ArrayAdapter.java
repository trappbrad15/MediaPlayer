...
/*  8 */   public ArrayAdapter(Context context, int resource, T[] objects) { throw new RuntimeException("Stub!"); } 
/*  9 */   public ArrayAdapter(Context context, int resource, int textViewResourceId, T[] objects) { throw new RuntimeException("Stub!"); } 
/* 10 */   public ArrayAdapter(Context context, int resource, List<T> objects) { throw new RuntimeException("Stub!"); } 
