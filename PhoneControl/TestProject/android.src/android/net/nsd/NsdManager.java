...
/* 26 */   public void registerService(NsdServiceInfo serviceInfo, int protocolType, RegistrationListener listener) { throw new RuntimeException("Stub!"); } 
/* 27 */   public void unregisterService(RegistrationListener listener) { throw new RuntimeException("Stub!"); } 
/* 28 */   public void discoverServices(String serviceType, int protocolType, DiscoveryListener listener) { throw new RuntimeException("Stub!"); } 
/* 29 */   public void stopServiceDiscovery(DiscoveryListener listener) { throw new RuntimeException("Stub!"); } 
/* 30 */   public void resolveService(NsdServiceInfo serviceInfo, ResolveListener listener) { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ 
 ...
 * Qualified Name:     android.net.nsd.NsdManager
