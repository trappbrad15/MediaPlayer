...
/*    */ {
/* 68 */   public static final Uri EMPTY = null; public static final Parcelable.Creator<Uri> CREATOR = null;
/*    */ 
/*    */   Uri()
/*    */   {
...
/* 60 */   public Uri normalizeScheme() { throw new RuntimeException("Stub!"); } 
/* 61 */   public static void writeToParcel(Parcel out, Uri uri) { throw new RuntimeException("Stub!"); } 
/* 62 */   public static String encode(String s) { throw new RuntimeException("Stub!"); } 
/* 63 */   public static String encode(String s, String allow) { throw new RuntimeException("Stub!"); } 
/* 64 */   public static String decode(String s) { throw new RuntimeException("Stub!"); } 
/* 65 */   public static Uri withAppendedPath(Uri baseUri, String pathSegment) { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ 
