...
/*  7 */   public LocaleSpan(Parcel src) { throw new RuntimeException("Stub!"); } 
...
/* 11 */   public Locale getLocale() { throw new RuntimeException("Stub!"); } 
 ...
 * Qualified Name:     android.text.style.LocaleSpan
