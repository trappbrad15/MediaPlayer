...
/* 40 */   public void setBackgroundColor(int bg) { throw new RuntimeException("Stub!"); } 
/* 41 */   protected float getScaleFactor() { throw new RuntimeException("Stub!"); } 
/* 42 */   public void setDetachWallpaper(boolean detachWallpaper) { throw new RuntimeException("Stub!"); } 
/* 43 */   public Interpolator getInterpolator() { throw new RuntimeException("Stub!"); } 
/* 44 */   public long getStartTime() { throw new RuntimeException("Stub!"); } 
/* 45 */   public long getDuration() { throw new RuntimeException("Stub!"); } 
/* 46 */   public long getStartOffset() { throw new RuntimeException("Stub!"); } 
/* 47 */   public int getRepeatMode() { throw new RuntimeException("Stub!"); } 
/* 48 */   public int getRepeatCount() { throw new RuntimeException("Stub!"); } 
/* 49 */   public boolean getFillBefore() { throw new RuntimeException("Stub!"); } 
/* 50 */   public boolean getFillAfter() { throw new RuntimeException("Stub!"); } 
/* 51 */   public int getZAdjustment() { throw new RuntimeException("Stub!"); } 
/* 52 */   public int getBackgroundColor() { throw new RuntimeException("Stub!"); } 
/* 53 */   public boolean getDetachWallpaper() { throw new RuntimeException("Stub!"); } 
/* 54 */   public boolean willChangeTransformationMatrix() { throw new RuntimeException("Stub!"); } 
/* 55 */   public boolean willChangeBounds() { throw new RuntimeException("Stub!"); } 
/* 56 */   public void setAnimationListener(AnimationListener listener) { throw new RuntimeException("Stub!"); } 
/* 57 */   protected void ensureInterpolator() { throw new RuntimeException("Stub!"); } 
/* 58 */   public long computeDurationHint() { throw new RuntimeException("Stub!"); } 
/* 59 */   public boolean getTransformation(long currentTime, Transformation outTransformation) { throw new RuntimeException("Stub!"); } 
/* 60 */   public boolean getTransformation(long currentTime, Transformation outTransformation, float scale) { throw new RuntimeException("Stub!"); } 
/* 61 */   public boolean hasStarted() { throw new RuntimeException("Stub!"); } 
/* 62 */   public boolean hasEnded() { throw new RuntimeException("Stub!"); } 
/* 63 */   protected void applyTransformation(float interpolatedTime, Transformation t) { throw new RuntimeException("Stub!"); } 
/* 64 */   protected float resolveSize(int type, float value, int size, int parentSize) { throw new RuntimeException("Stub!"); } 
