...
/* 163 */     public static final Parcelable.Creator<LayoutParams> CREATOR = null;
...
/*  22 */     public LayoutParams(int _type) { super(); throw new RuntimeException("Stub!"); } 
/*  23 */     public LayoutParams(int _type, int _flags) { super(); throw new RuntimeException("Stub!"); } 
/*  24 */     public LayoutParams(int _type, int _flags, int _format) { super(); throw new RuntimeException("Stub!"); } 
/*  25 */     public LayoutParams(int w, int h, int _type, int _flags, int _format) { super(); throw new RuntimeException("Stub!"); } 
/*  26 */     public LayoutParams(int w, int h, int xpos, int ypos, int _type, int _flags, int _format) { super(); throw new RuntimeException("Stub!"); } 
/*  27 */     public LayoutParams(Parcel in) { super(); throw new RuntimeException("Stub!"); } 
/*  28 */     public static boolean mayUseInputMethod(int flags) { throw new RuntimeException("Stub!"); } 
/*  29 */     public final void setTitle(CharSequence title) { throw new RuntimeException("Stub!"); } 
/*  30 */     public final CharSequence getTitle() { throw new RuntimeException("Stub!"); } 
/*  31 */     public int describeContents() { throw new RuntimeException("Stub!"); } 
/*  32 */     public void writeToParcel(Parcel out, int parcelableFlags) { throw new RuntimeException("Stub!"); } 
/*  33 */     public final int copyFrom(LayoutParams o) { throw new RuntimeException("Stub!"); } 
/*  34 */     public String debug(String output) { throw new RuntimeException("Stub!"); } 
...
/*  15 */     public InvalidDisplayException(String name) { throw new RuntimeException("Stub!"); }
/*     */ 
/*     */   }
/*     */ 
...
/*   9 */     public BadTokenException(String name) { throw new RuntimeException("Stub!"); }
/*     */ 
/*     */   }
/*     */ }
