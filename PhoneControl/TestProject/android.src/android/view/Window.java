...
/*  29 */   public final Context getContext() { throw new RuntimeException("Stub!"); } 
/*  30 */   public final TypedArray getWindowStyle() { throw new RuntimeException("Stub!"); } 
/*  31 */   public void setContainer(Window container) { throw new RuntimeException("Stub!"); } 
/*  32 */   public final Window getContainer() { throw new RuntimeException("Stub!"); } 
/*  33 */   public final boolean hasChildren() { throw new RuntimeException("Stub!"); } 
/*  34 */   public void setWindowManager(WindowManager wm, IBinder appToken, String appName) { throw new RuntimeException("Stub!"); } 
/*  35 */   public void setWindowManager(WindowManager wm, IBinder appToken, String appName, boolean hardwareAccelerated) { throw new RuntimeException("Stub!"); } 
/*  36 */   public WindowManager getWindowManager() { throw new RuntimeException("Stub!"); } 
/*  37 */   public void setCallback(Callback callback) { throw new RuntimeException("Stub!"); } 
/*  38 */   public final Callback getCallback() { throw new RuntimeException("Stub!"); } 
...
/*     */ 
/*  42 */   public void setLayout(int width, int height) { throw new RuntimeException("Stub!"); } 
...
/*  45 */   public void setFormat(int format) { throw new RuntimeException("Stub!"); } 
/*  46 */   public void setWindowAnimations(int resId) { throw new RuntimeException("Stub!"); } 
/*  47 */   public void setSoftInputMode(int mode) { throw new RuntimeException("Stub!"); } 
/*  48 */   public void addFlags(int flags) { throw new RuntimeException("Stub!"); } 
/*  49 */   public void clearFlags(int flags) { throw new RuntimeException("Stub!"); } 
/*  50 */   public void setFlags(int flags, int mask) { throw new RuntimeException("Stub!"); } 
/*  51 */   public void setDimAmount(float amount) { throw new RuntimeException("Stub!"); } 
/*  52 */   public void setAttributes(WindowManager.LayoutParams a) { throw new RuntimeException("Stub!"); } 
/*  53 */   public final WindowManager.LayoutParams getAttributes() { throw new RuntimeException("Stub!"); } 
/*  54 */   protected final int getForcedWindowFlags() { throw new RuntimeException("Stub!"); } 
/*  55 */   protected final boolean hasSoftInputMode() { throw new RuntimeException("Stub!"); } 
/*  56 */   public boolean requestFeature(int featureId) { throw new RuntimeException("Stub!"); } 
/*  57 */   public final void makeActive() { throw new RuntimeException("Stub!"); } 
/*  58 */   public final boolean isActive() { throw new RuntimeException("Stub!"); } 
/*  59 */   public View findViewById(int id) { throw new RuntimeException("Stub!"); } 
...
/*     */ 
/*  77 */   public void setBackgroundDrawableResource(int resid) { throw new RuntimeException("Stub!"); } 
...
/*     */ 
/*  95 */   protected final int getFeatures() { throw new RuntimeException("Stub!"); } 
/*  96 */   public boolean hasFeature(int feature) { throw new RuntimeException("Stub!"); } 
/*  97 */   protected final int getLocalFeatures() { throw new RuntimeException("Stub!"); } 
/*  98 */   protected void setDefaultWindowFormat(int format) { throw new RuntimeException("Stub!"); } 
...
/*     */ 
/* 104 */   public void setUiOptions(int uiOptions) { throw new RuntimeException("Stub!"); } 
/* 105 */   public void setUiOptions(int uiOptions, int mask) { throw new RuntimeException("Stub!"); }
/*     */ 
/*     */ 
