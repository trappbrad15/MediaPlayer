...
/* 18 */   public int setScalingMode(int mode) throws IllegalStateException { throw new RuntimeException("Stub!"); } 
/* 19 */   public int getScalingMode() throws IllegalStateException { throw new RuntimeException("Stub!"); } 
/* 20 */   public int getSamplingRate() throws IllegalStateException { throw new RuntimeException("Stub!"); } 
/* 21 */   public int getWaveForm(byte[] waveform) throws IllegalStateException { throw new RuntimeException("Stub!"); } 
/* 22 */   public int getFft(byte[] fft) throws IllegalStateException { throw new RuntimeException("Stub!"); } 
/* 23 */   public int setDataCaptureListener(OnDataCaptureListener listener, int rate, boolean waveform, boolean fft) { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ 
