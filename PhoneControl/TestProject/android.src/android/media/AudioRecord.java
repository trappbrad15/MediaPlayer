...
/* 22 */   public int getAudioSessionId() { throw new RuntimeException("Stub!"); } 
/* 23 */   public void startRecording() throws IllegalStateException { throw new RuntimeException("Stub!"); } 
/* 24 */   public void startRecording(MediaSyncEvent syncEvent) throws IllegalStateException { throw new RuntimeException("Stub!"); } 
/* 25 */   public void stop() throws IllegalStateException { throw new RuntimeException("Stub!"); } 
/* 26 */   public int read(byte[] audioData, int offsetInBytes, int sizeInBytes) { throw new RuntimeException("Stub!"); } 
/* 27 */   public int read(short[] audioData, int offsetInShorts, int sizeInShorts) { throw new RuntimeException("Stub!"); } 
/* 28 */   public int read(ByteBuffer audioBuffer, int sizeInBytes) { throw new RuntimeException("Stub!"); } 
/* 29 */   public void setRecordPositionUpdateListener(OnRecordPositionUpdateListener listener) { throw new RuntimeException("Stub!"); } 
/* 30 */   public void setRecordPositionUpdateListener(OnRecordPositionUpdateListener listener, Handler handler) { throw new RuntimeException("Stub!"); } 
/* 31 */   public int setNotificationMarkerPosition(int markerInFrames) { throw new RuntimeException("Stub!"); } 
/* 32 */   public int setPositionNotificationPeriod(int periodInFrames) { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ 
