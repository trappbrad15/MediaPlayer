...
/* 25 */   public void setSpeakerphoneOn(boolean on) { throw new RuntimeException("Stub!"); } 
/* 26 */   public boolean isSpeakerphoneOn() { throw new RuntimeException("Stub!"); } 
/* 27 */   public boolean isBluetoothScoAvailableOffCall() { throw new RuntimeException("Stub!"); } 
/* 28 */   public void startBluetoothSco() { throw new RuntimeException("Stub!"); } 
/* 29 */   public void stopBluetoothSco() { throw new RuntimeException("Stub!"); } 
/* 30 */   public void setBluetoothScoOn(boolean on) { throw new RuntimeException("Stub!"); } 
/* 31 */   public boolean isBluetoothScoOn() { throw new RuntimeException("Stub!"); } 
/* 33 */   @Deprecated
/*    */   public void setBluetoothA2dpOn(boolean on) { throw new RuntimeException("Stub!"); } 
/* 34 */   public boolean isBluetoothA2dpOn() { throw new RuntimeException("Stub!"); } 
/* 36 */   @Deprecated
...
/* 39 */   public void setMicrophoneMute(boolean on) { throw new RuntimeException("Stub!"); } 
/* 40 */   public boolean isMicrophoneMute() { throw new RuntimeException("Stub!"); } 
/* 41 */   public void setMode(int mode) { throw new RuntimeException("Stub!"); } 
/* 42 */   public int getMode() { throw new RuntimeException("Stub!"); } 
/* 44 */   @Deprecated
...
/* 47 */   public boolean isMusicActive() { throw new RuntimeException("Stub!"); } 
/* 48 */   public void setParameters(String keyValuePairs) { throw new RuntimeException("Stub!"); } 
/* 49 */   public String getParameters(String keys) { throw new RuntimeException("Stub!"); } 
/* 50 */   public void playSoundEffect(int effectType) { throw new RuntimeException("Stub!"); } 
/* 51 */   public void playSoundEffect(int effectType, float volume) { throw new RuntimeException("Stub!"); } 
/* 52 */   public void loadSoundEffects() { throw new RuntimeException("Stub!"); } 
/* 53 */   public void unloadSoundEffects() { throw new RuntimeException("Stub!"); } 
/* 54 */   public int requestAudioFocus(OnAudioFocusChangeListener l, int streamType, int durationHint) { throw new RuntimeException("Stub!"); } 
/* 55 */   public int abandonAudioFocus(OnAudioFocusChangeListener l) { throw new RuntimeException("Stub!"); } 
/* 56 */   public void registerMediaButtonEventReceiver(ComponentName eventReceiver) { throw new RuntimeException("Stub!"); } 
/* 57 */   public void registerMediaButtonEventReceiver(PendingIntent eventReceiver) { throw new RuntimeException("Stub!"); } 
/* 58 */   public void unregisterMediaButtonEventReceiver(ComponentName eventReceiver) { throw new RuntimeException("Stub!"); } 
/* 59 */   public void unregisterMediaButtonEventReceiver(PendingIntent eventReceiver) { throw new RuntimeException("Stub!"); } 
/* 60 */   public void registerRemoteControlClient(RemoteControlClient rcClient) { throw new RuntimeException("Stub!"); } 
/* 61 */   public void unregisterRemoteControlClient(RemoteControlClient rcClient) { throw new RuntimeException("Stub!"); } 
/* 62 */   public String getProperty(String key) { throw new RuntimeException("Stub!"); }
/*    */ 
/*    */ 
