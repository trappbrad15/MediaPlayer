...
/* 5 */   public Effect createEffect(String effectName) { throw new RuntimeException("Stub!"); } 
/* 6 */   public static boolean isEffectSupported(String effectName) { throw new RuntimeException("Stub!"); }
/*   */ 
/*   */ }
